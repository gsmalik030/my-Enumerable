...
**[my-enumerable]** is a Ruby based project that leverages the use of a module inside a class.
...
```sh
  cd my-enumerable
  git clone https://github.com/gsmalik030/my-enumerable.git
```
...
Feel free to check the [issues page](https://github.com/gsmalik030/my-enumerable/issues).
